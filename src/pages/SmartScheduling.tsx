            ...
            <Card className="shadow-soft">
              <CardHeader>
                <div className="flex items-center justify-between">
                  <div>
                    <CardTitle>AI-Optimized Task Schedule</CardTitle>
                    <CardDescription>Tasks optimized for weather, crop cycles, and efficiency</CardDescription>
                  </div>
                  ...
                  <div key={task.id} className="border rounded-lg p-4 space-y-3">
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-4 text-xs">
                      ...
                      <div>
                        ...
                        <p className="font-medium">{task.cropStage}</p>
                      </div>
                      <div>
